...
function ProductList() {
    ...
    const cart = useSelector(state => state.cart.items); // Retrieve the cart state from Redux
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowPlants(true); // Show the product listing page when "Plants" is clicked
                ...
                <div style={styleObjUl}>
                    ...
                    <div> 
                        <a href="#" onClick={handleCartClick} style={styleA}>
                            ...
                            <div className="cart-count">{totalQuantity}</div> {/* Display total number of items in the cart */}
                        </a>
                    </div>
                </div>
            </div>

            {/* Display product listing or cart based on showCart state */}
            {!showCart ? (
